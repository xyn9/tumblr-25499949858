...
{% if post.group == "history" and post.title != null %}
- %(timestamp){{ post.date | date: site.theme.date_format }}%	"{{ post.title| xml_escape }}":{% if post.link %}{{ post.link }}{% else %}{{ post.url }}{% endif %} :=
